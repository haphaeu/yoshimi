...
class MyApp(QtGui.QWidget):
    def __init__(self):
        ...
        self.table_filter = QtGui.QTableWidget(self)

        self.button1 = QtGui.QPushButton('Open...', self)
        self.button1.clicked.connect(self.open_file)

        self.button2 = QtGui.QPushButton('Filter ==>', self)
        ...
        for i, h in enumerate(['WaveHs', 'WaveTp', 'WaveDirection']):
            self.table_filter.setHorizontalHeaderItem(i, QtGui.QTableWidgetItem(h))
