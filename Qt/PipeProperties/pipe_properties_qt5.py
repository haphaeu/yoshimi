...
Updated 28.10.2017 - converted to PyQt5
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # tests
        # self.comboMaterial = QtWidgets.QComboBox(self)
        # self.test = QtWidgets.QLineEdit(self)
        # self.test.
        ...
        for i, h in enumerate(headers):
            self.table.setVerticalHeaderItem(i, QtWidgets.QTableWidgetItem(h))
    ...
    def copyCol(self):
        ...
        if self.table.item(0, num_cols-1) is None:
            return
    ...
    def do_calcs(self, row, col):
        ...
        if row in {0, 1, 3, 4, 5, 6, 7, 8, 9, 10}:
            ...
            self.table.setHorizontalHeaderItem(col, QtWidgets.QTableWidgetItem(h))
